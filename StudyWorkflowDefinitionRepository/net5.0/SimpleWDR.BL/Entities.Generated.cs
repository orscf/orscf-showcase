...
public class Arm {
  ...
  [Principal]
  public virtual ResearchStudy ResearchStudy { get; set; }
  ...
  [Lookup]
  public virtual ProcedureSchedule RootProcedureSchedule { get; set; }
...
public class ResearchStudy {
  ...
  [Dependent]
  public virtual ObservableCollection<Arm> Arms { get; set; } = new ObservableCollection<Arm>();

  [Dependent]
  public virtual ObservableCollection<DataRecordingTask> DataRecordingTasks { get; set; } = new ObservableCollection<DataRecordingTask>();

  [Dependent]
  public virtual ObservableCollection<DrugApplymentTask> DrugApplymentTasks { get; set; } = new ObservableCollection<DrugApplymentTask>();

  [Dependent]
  public virtual ObservableCollection<ProcedureSchedule> ProcedureSchedules { get; set; } = new ObservableCollection<ProcedureSchedule>();

  [Dependent]
  public virtual ObservableCollection<TreatmentTask> TreatmentTasks { get; set; } = new ObservableCollection<TreatmentTask>();

  [Dependent]
  public virtual ObservableCollection<TaskSchedule> TaskSchedules { get; set; } = new ObservableCollection<TaskSchedule>();

  [Dependent]
  public virtual ObservableCollection<VisitProdecureDefinition> VisitProdecureDefinitions { get; set; } = new ObservableCollection<VisitProdecureDefinition>();

  [Dependent]
  public virtual ObservableCollection<StudyEvent> Events { get; set; } = new ObservableCollection<StudyEvent>();
...
public class ProcedureSchedule {
  ...
  /// <summary> the ProcedureSchedule which is representing the primary-/entry-workflow (estimated visits) for participants of this arm </summary>
  [Referer]
  public virtual ObservableCollection<Arm> EntryArms { get; set; } = new ObservableCollection<Arm>();

  [Dependent]
  public virtual ObservableCollection<InducedSubProcedureSchedule> InducedSubProcedureSchedules { get; set; } = new ObservableCollection<InducedSubProcedureSchedule>();

  [Referer]
  public virtual ObservableCollection<InducedSubProcedureSchedule> InducingSubProcedureSchedules { get; set; } = new ObservableCollection<InducedSubProcedureSchedule>();

  [Dependent]
  public virtual ObservableCollection<InducedVisitProcedure> InducedProcedures { get; set; } = new ObservableCollection<InducedVisitProcedure>();
...
public class DataRecordingTask {
  ...
  [Referer]
  public virtual ObservableCollection<InducedDataRecordingTask> Inducements { get; set; } = new ObservableCollection<InducedDataRecordingTask>();
...
public class InducedDataRecordingTask {
  ...
  [Lookup]
  public virtual DataRecordingTask InducedTask { get; set; }
...
public class DrugApplymentTask {
  ...
  [Referer]
  public virtual ObservableCollection<InducedDrugApplymentTask> Inducements { get; set; } = new ObservableCollection<InducedDrugApplymentTask>();
...
public class InducedDrugApplymentTask {
  ...
  [Lookup]
  public virtual DrugApplymentTask InducedTask { get; set; }
...
public class TaskSchedule {
  ...
  [Dependent]
  public virtual ObservableCollection<InducedDataRecordingTask> InducedDataRecordingTasks { get; set; } = new ObservableCollection<InducedDataRecordingTask>();

  [Dependent]
  public virtual ObservableCollection<InducedDrugApplymentTask> InducedDrugApplymentTasks { get; set; } = new ObservableCollection<InducedDrugApplymentTask>();

  [Dependent]
  public virtual ObservableCollection<InducedSubTaskSchedule> InducedSubTaskSchedules { get; set; } = new ObservableCollection<InducedSubTaskSchedule>();

  [Referer]
  public virtual ObservableCollection<InducedSubTaskSchedule> InducingTaskSchedules { get; set; } = new ObservableCollection<InducedSubTaskSchedule>();

  [Dependent]
  public virtual ObservableCollection<InducedTreatmentTask> InducedTreatmentTasks { get; set; } = new ObservableCollection<InducedTreatmentTask>();
  ...
  [Referer]
  public virtual ObservableCollection<VisitProdecureDefinition> EntryVisitProdecureDefinitions { get; set; } = new ObservableCollection<VisitProdecureDefinition>();
...
public class InducedSubProcedureSchedule {
  ...
  [Principal]
  public virtual ProcedureSchedule ParentProcedureSchedule { get; set; }

  [Lookup]
  public virtual ProcedureSchedule InducedProcedureSchedule { get; set; }
...
public class InducedSubTaskSchedule {
  ...
  [Principal]
  public virtual TaskSchedule ParentTaskSchedule { get; set; }

  [Lookup]
  public virtual TaskSchedule InducedTaskSchedule { get; set; }
...
public class InducedTreatmentTask {
  ...
  [Lookup]
  public virtual TreatmentTask InducedTask { get; set; }
...
public class TreatmentTask {
  ...
  [Referer]
  public virtual ObservableCollection<InducedTreatmentTask> Inducements { get; set; } = new ObservableCollection<InducedTreatmentTask>();
...
public class InducedVisitProcedure {
  ...
  [Principal]
  public virtual ProcedureSchedule ProcedureSchedule { get; set; }

  [Lookup]
  public virtual VisitProdecureDefinition InducedVisitProdecure { get; set; }
...
public class VisitProdecureDefinition {
  ...
  [Referer]
  public virtual ObservableCollection<InducedVisitProcedure> Inducements { get; set; } = new ObservableCollection<InducedVisitProcedure>();
  ...
  /// <summary> the TaskSchedule which is representing the primary-/entry-workflow (estimated tasks) when executing this visit </summary>
  [Lookup]
  public virtual TaskSchedule RootTaskSchedule { get; set; }
